...
sh " sonar-scanner -Dsonar.projectKey=${component} -Dsonar.sources=. -Dsonar.host.url=http://3.236.21.181:9000 -Dsonar.login=4c74445d6f0232091da066dd3be902b418fdd436"
}
